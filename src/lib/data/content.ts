...
export const testimonials = [
  {
    ...
    role: "Project Director, Gulf Build Co.",
    quote:
      "Tasheel delivered twelve elevators on a compressed timeline without compromising quality. Their site discipline and engineering clarity set them apart.",
    rating: 5,
  },
  {
    name: "Sarah Mitchell",
    role: "Hospitality Operations, Sahara Hotel",
    quote:
      "From installation through AMC, the team is responsive and professional. Guest elevators run quietly and our service lifts just work.",
    rating: 5,
  },
  {
    name: "Omar Al Balushi",
    role: "Facilities Manager, Oasis City Mall",
    quote:
      "Their escalator maintenance program reduced downtime significantly. Reporting is clear and technicians know the equipment inside out.",
    rating: 5,
  },
];
...
export const processSteps = [
  { title: "Consultation", description: "Understand traffic, architecture, and commercial goals." },
  { title: "Survey", description: "Measure shafts, pits, and site constraints with precision." },
  { title: "Design", description: "Specify products, finishes, and compliance packages." },
  { title: "Manufacturing", description: "Quality-controlled production and factory checks." },
  { title: "Installation", description: "Certified crews, phased schedules, strict safety." },
  { title: "Testing", description: "Load tests, safety verification, and fine-tuning." },
  { title: "Handover", description: "Training, documentation, and warranty activation." },
  { title: "Maintenance", description: "AMC programs that protect long-term performance." },
];

export const whyChoose = [
  { title: "Fast Installation", description: "Coordinated crews and phased handovers that respect your programme.", icon: "Zap" },
  { title: "Certified Engineers", description: "Factory-trained technicians and documented competency.", icon: "BadgeCheck" },
  { title: "24/7 Support", description: "Emergency response and remote diagnostics when you need them.", icon: "Clock" },
  { title: "Original Parts", description: "Genuine components that preserve safety and performance.", icon: "Package" },
  { title: "Safety Standards", description: "EN 81 / EN 115 aligned systems and site practices.", icon: "Shield" },
  { title: "Warranty Assurance", description: "Clear coverage with accountable after-sales service.", icon: "FileCheck" },
  { title: "AMC Excellence", description: "Preventive care with digital reports and uptime focus.", icon: "ClipboardList" },
  { title: "Transparent Pricing", description: "Detailed proposals—no surprises from quote to handover.", icon: "Wallet" },
];

export const values = [
  { title: "Safety First", description: "Every decision starts with passenger and technician safety." },
  { title: "Engineering Integrity", description: "We specify honestly and install precisely." },
  { title: "Long-Term Partnership", description: "Projects end at handover; relationships continue through AMC." },
  { title: "Regional Excellence", description: "Built for Oman and the GCC—climate, codes, and culture." },
];

export const timeline = [
  { year: "2007", title: "Founded in Muscat", description: "Tasheel begins with installation and maintenance services." },
  { year: "2012", title: "GCC Expansion", description: "First major cross-border hospitality and commercial projects." },
  { year: "2016", title: "Modernization Division", description: "Dedicated team for legacy system upgrades." },
  { year: "2020", title: "Digital Service Platform", description: "IoT-ready monitoring and digital AMC reporting." },
  { year: "2024", title: "850+ Projects", description: "Trusted by developers, hospitals, malls, and government clients." },
];
