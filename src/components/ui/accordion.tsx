...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-5 text-left font-display text-lg font-semibold transition-all hover:text-electric [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
