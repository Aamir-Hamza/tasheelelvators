      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          {projects.map((project) => {
            const title = tx(t, `gallery.${project.slug}.title`, project.title);
            const location = tx(t, `gallery.${project.slug}.location`, project.location);
            const summary = tx(t, `gallery.${project.slug}.summary`, project.summary);
            return (
              <article
                key={project.slug}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-3 line-clamp-2 text-sm text-slate-300">{summary}</p>
                </div>
              </article>
            );
          })}
