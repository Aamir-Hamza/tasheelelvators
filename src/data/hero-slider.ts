...
export const HERO_SLIDER_SLIDES: HeroSliderSlide[] = [
  ...
  },
  {
    ...
    cta: { label: "Explore Smart Systems", href: "/cctv-smart-systems" },
  ...
  },
  {
    ...
    alt: "Tasheel Maintenance — preventive AMC banner",
    eyebrow: "Predictive Care",
    title: "Preventive Maintenance",
    subtitle: "AMC programmes built for zero downtime.",
